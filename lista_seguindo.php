...
// Busca a lista de pessoas que esse usuário segue
...
<head>
    ...
    <title>Usuários que <?php echo htmlspecialchars($nome_usuario); ?> segue</title>
...
<body>
    ...
    <main class="lista-usuarios-container">
        <h1>Seguindo (<?php echo $resultado_lista->num_rows; ?>)</h1>
        <p>Pessoas que <?php echo htmlspecialchars($nome_usuario); ?> segue.</p>
        ...
        <div class="lista-usuarios">
            <?php if ($resultado_lista->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p><?php echo htmlspecialchars($nome_usuario); ?> não segue ninguém.</p>
            <?php endif; ?>
        </div>
    </main>
    <?php $conn->close(); ?>
